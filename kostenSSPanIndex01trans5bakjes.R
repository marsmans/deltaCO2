...
bakje3.median <- median(ind.bakje3$Costs, na.rm = T) #0.566732503
...
bakje1.max <- quantile(ind.bakje1$Costs, 0.9, na.rm = T) #5.174643076

bakje2.min <- quantile(ind.bakje2$Costs, 0.1, na.rm = T)
bakje2.max <- quantile(ind.bakje2$Costs, 0.9, na.rm = T)

bakje3.min <- quantile(ind.bakje3$Costs, 0.1, na.rm = T) #0.149500753
bakje3.max <- quantile(ind.bakje3$Costs, 0.9, na.rm = T) #1.865747666
...
costs.oneRun <- function(deltaCO2, trans01) {
  ...
  exp.kosten.min <- 1.4577*exp(-1.32*deltaCO2)
  exp.kosten.max <- (9.8357*exp(-0.851*deltaCO2) - 0.1)
  #exp.kosten.max <- 8.5055*exp(-0.804*deltaCO2)
...
f.costs.CCmatrix <- function(N,f.seed) {
  ...
  rownames(CCmatrixP) <- as.character(seq(1.5, 3.5, by = 0.1))
  rownames(CCmatrixS) <- as.character(seq(1.5, 3.5, by = 0.1))
